  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-100 via-pink-100 to-yellow-100 p-6 flex flex-col items-center">
      ...
      <header className="text-center mb-16">
        <h1 className="text-5xl md:text-6xl font-extrabold text-gray-800 mb-4">About TicketBari</h1>
      ...
      {/* Project Overview */}
      <section className="w-full max-w-5xl bg-white rounded-3xl shadow-lg p-10 mb-16">
      ...
      <section className="w-full max-w-6xl mb-16">
        <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center">Our Core Services</h2>
      ...
      {/* Why Choose Us */}
      <section className="w-full max-w-5xl bg-white rounded-3xl shadow-lg p-10 mb-16">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Why Choose TicketBari?</h2>
      ...
      {/* Technology & Workflow */}
      <section className="w-full max-w-5xl bg-white rounded-3xl shadow-lg p-10 mb-16">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Technology & Workflow</h2>
      ...
      {/* Team / Experience */}
      <section className="w-full max-w-6xl mb-16">
        <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center">Our Expertise</h2>
...
const ServiceCard = ({ icon, title, description }) => (
  <div className="bg-white p-6 rounded-2xl shadow-lg flex flex-col items-center text-center hover:scale-105 transform transition duration-300">
