    ...
    <div className="max-w-5xl mx-auto my-16 px-4 sm:px-6 lg:px-8">
      <div className=" shadow-2xl rounded-3xl border border-gray-100 p-8 sm:p-12 flex flex-col md:flex-row gap-10">
        ...
        <div className="md:w-1/3 flex flex-col items-center border-b md:border-b-0 md:border-r border-gray-200 pb-8 md:pb-0 md:pr-10">
          <div className="w-40 h-40 rounded-full shadow-xl ring-4 ring-blue-500 ring-opacity-20 flex items-center justify-center overflow-hidden transition-transform transform hover:scale-105 duration-300">
            {user?.photoURL ? (
              <img
                src={user.photoURL}
          ...
          <p className="text-sm font-medium text-blue-600 py-1 px-3 rounded-full mt-2 shadow-sm">
            {isLoading ? (
        ...
        <div className="md:w-2/3 flex-1 w-full space-y-6">
          <h3 className="text-2xl font-bold border-b pb-2 mb-4">Account Details</h3>
          ...
          <div className="flex items-center gap-4 p-5 rounded-xl border shadow-md transition duration-300 hover:shadow-lg">
